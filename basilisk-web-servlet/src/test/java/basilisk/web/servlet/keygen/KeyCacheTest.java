...
public class KeyCacheTest {
    ...
    public void testKeyCache() {
        ...
        assertEquals("Could not find session key in storage for service with IP: 1.1.1.1", ex.getMessage());
        ...
        assertEquals("Could not find encoding key in storage for service with IP: 1.1.1.1", ex.getMessage());
        ...
        assertEquals("Could not find mac key in storage for service with IP: 1.1.1.1", ex.getMessage());
